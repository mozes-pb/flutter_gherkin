...
class FlutterAppRunnerHook extends Hook {
  ...
  Future<void> _runApp(FlutterTestConfiguration config) async {
    ...
    _flutterRunProcessHandler.setiOSDeviceName(config.iosDeviceName);
    _flutterRunProcessHandler.setBypassPermissions(config.permissions);
    _flutterRunProcessHandler.setBundleId(config.bundleId);
